...
export const SPECIALISTS_UPDATED_AT = '2026-08-25';

export const SPECIALIST_BLOCKS: readonly SpecialistBlock[] = [
  { team: 'Atalanta', kind: 'rigori', names: ['Scamacca', 'Samardzic', 'Ederson D.S.', 'De Ketelaere', 'Krstovic'] },
  { team: 'Bologna', kind: 'rigori', names: ['Orsolini', 'Dovbyk', 'Bernardeschi', 'Ferguson'] },
  { team: 'Cagliari', kind: 'rigori', names: ['Esposito Se.', 'Fazzini', 'Mina', 'Borrelli', 'Deiola'] },
  { team: 'Como', kind: 'rigori', names: ['Da Cunha', 'Paz N.', 'Douvikas', 'Baturina'] },
  { team: 'Fiorentina', kind: 'rigori', names: ['Kean', 'Gudmundsson A.', 'Mandragora', 'Mastantuono'] },
  { team: 'Frosinone', kind: 'rigori', names: ['Schmid', 'Calò'] },
  ...
  { team: 'Juventus', kind: 'rigori', names: ['Kolo Muani', 'Locatelli', 'Yildiz', 'David'] },
  { team: 'Lazio', kind: 'rigori', names: ['Zaccagni', 'Taylor K.', 'Cataldi'] },
  { team: 'Lecce', kind: 'rigori', names: ['Geubbels', 'Stulic', 'Pierotti', 'Gallo'] },
  { team: 'Milan', kind: 'rigori', names: ['Ramos G.', 'Nkunku', 'Pulisic', 'Leao'] },
  ...
  { team: 'Sassuolo', kind: 'rigori', names: ['Berardi', 'Pinamonti', 'Laurientè', 'Bowie'] },
  { team: 'Torino', kind: 'rigori', names: ['Vlasic', 'Kulenovic', 'Zapata D.'] },
  ...
  { team: 'Como', kind: 'punizioni', names: ['Nico Paz', 'Baturina', 'Da Cunha', 'Perrone'] },
  { team: 'Fiorentina', kind: 'punizioni', names: ['Gudmundsson', 'Mastantuono', 'Mandragora', 'Fagioli'] },
  ...
  { team: 'Lazio', kind: 'punizioni', names: ['Zaccagni', 'Cataldi', 'Taylor', 'Rovella'] },
  { team: 'Lecce', kind: 'punizioni', names: ['Gallo', 'Pierotti', 'Berisha'] },
  { team: 'Milan', kind: 'punizioni', names: ['Modric', 'Pulisic', 'Ricci', 'Jashari'] },
  ...
  { team: 'Sassuolo', kind: 'punizioni', names: ['Berardi', 'Laurienté', 'Volpato'] },
  { team: 'Torino', kind: 'punizioni', names: ['Vlasic', 'Oristanio', 'Ilic', 'Coco'] },
  ...
  { team: 'Cagliari', kind: 'corner', names: ['Fazzini', 'Obert', 'Romano', 'Maldini', 'Winks', 'Prati'] },
  { team: 'Como', kind: 'corner', names: ['Baturina', 'Nico Paz', 'Da Cunha', 'Perrone', 'Addai'] },
  { team: 'Fiorentina', kind: 'corner', names: ['Gudmundsson', 'Mastantuono', 'Mandragora', 'Fagioli', 'Dodo'] },
  ...
  { team: 'Juventus', kind: 'corner', names: ['Yildiz', 'Cambiaso', 'Locatelli', 'Koopmeiners', 'Zhegrova'] },
  { team: 'Lazio', kind: 'corner', names: ['Zaccagni', 'Taylor', 'Rovella', 'Cataldi'] },
  { team: 'Lecce', kind: 'corner', names: ['Gallo', 'Pierotti', 'Berisha'] },
  ...
  { team: 'Sassuolo', kind: 'corner', names: ['Berardi', 'Laurienté', 'Volpato', 'Doig'] },
  { team: 'Torino', kind: 'corner', names: ['Vlasic', 'Oristanio', 'Ilic'] },
