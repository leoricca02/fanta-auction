...
export const SPECIALISTS_UPDATED_AT = '2026-09-01';
...
export const SPECIALIST_BLOCKS: readonly SpecialistBlock[] = [
  ...
  { team: 'Cagliari', kind: 'rigori', names: ['Fazzini', 'Mina', 'Borrelli', 'Deiola'] },
  { team: 'Como', kind: 'rigori', names: ['Da Cunha', 'Kean', 'Paz N.', 'Douvikas', 'Baturina'] },
  { team: 'Fiorentina', kind: 'rigori', names: ['Mastantuono'] },
  ...
  { team: 'Milan', kind: 'rigori', names: ['Ramos G.', 'Pulisic'] },
  ...
  { team: 'Torino', kind: 'punizioni', names: ['Vlasic', 'Fitz-Jim', 'Coco', 'Oristanio'] },
  ...
  { team: 'Torino', kind: 'corner', names: ['Vlasic', 'Fitz-Jim'] },
