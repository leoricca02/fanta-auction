 ...
 * toglieva la giornata di rientro senza far fallire niente. Il 10 settembre e'
 * toccato a Felici, con `in dubbio per 29a` senza `la`: stesso guasto muto, per
 * questo adesso l'articolo e' opzionale quanto il punto.
 */
