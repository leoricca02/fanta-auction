 ...
 *
 * Scrive solo le fasce. I commenti della guida sugli infortunati stavano qui
 * fino al 2026-09-04: adesso gli infortuni hanno una fonte loro, la tabella
 * indisponibili, che li elenca tutti e dice la giornata di rientro invece di
 * commentare otto big. Vedi `scripts/build-injuries.mjs`.
 */
